...
// ── Main Panel ────────────────────────────────────────────────────────────────
type View = 'dashboard' | 'restaurants' | 'new' | 'edit' | 'users' | 'knowledge' | 'assistant' | 'blog';
...
function SuperAdminContent({ onLogout }: { onLogout: () => void }) {
  ...
  const navItems = [
    ...
    { id: 'blog' as View,        icon: Newspaper,        label: 'Blog', labelShort: 'Blog' },
  ];
