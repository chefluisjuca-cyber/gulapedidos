  ...
  return (
    <div className="p-3 sm:p-6 max-w-6xl mx-auto space-y-6 sm:space-y-8">
      <div>
        ...
        <TutorialHelpButton videoId="84ZzKzTXnM8" title="Primeiros Passos" />
      </div>
...
{/* Mesas / QR Codes */}
      <section className="bg-[#0f2040] rounded-2xl p-6 border border-[#1e3868] space-y-5">
        ...
        {/* Display para download */}
        <div className="bg-[#1a3260]/60 border border-amber-500/20 rounded-xl p-4 flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-amber-500/20 flex items-center justify-center shrink-0">
            <Monitor className="w-5 h-5 text-amber-400" />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-white">Modelo de Display</p>
            <p className="text-xs text-slate-400 mt-0.5">Baixe um modelo pronto para exibir nas mesas ou balcão.</p>
          </div>
          <a
            href="/display.jpg"
            download
