...
import { Plus, Pencil, Trash2, X, Check, ChevronDown, ChevronUp, Tag, Package, Layers, Copy, AlertCircle } from 'lucide-react';
    ...
    <div className="p-3 sm:p-6 max-w-6xl mx-auto space-y-6 sm:space-y-8">
      ...
      {modal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-[#0f2040] border border-[#1e3868] rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
