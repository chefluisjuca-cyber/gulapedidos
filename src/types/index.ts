    ...
    variants: [
      {
        ...
        prices: [
          ...
          { cycle: 'semestral', label: 'Semestral', price: 269.99, stripe_price_id: 'price_1Tuzc8RNhmPZU507zLjEWUPw' },
          { cycle: 'anual',     label: 'Anual',     price: 449.99, stripe_price_id: 'price_1Tuzc8RNhmPZU5076SmweTHX' },
        ],
      },
      {
        tier: 'regular',
    ...
    variants: [
      {
        ...
        label: 'Promocional',
        prices: [
          { cycle: 'mensal',    label: 'Mensal',    price:  79.99, stripe_price_id: 'price_1TuzdHRNhmPZU507rVBBE8I1' },
          { cycle: 'semestral', label: 'Semestral', price: 431.99, stripe_price_id: 'price_1TuzeXRNhmPZU507Gt3sXGyk' },
          { cycle: 'anual',     label: 'Anual',     price: 719.99, stripe_price_id: 'price_1TuzeWRNhmPZU5076yEeYA05' },
        ],
      },
      {
        tier: 'regular',
    ...
    variants: [
      {
        ...
        label: 'Promocional',
        prices: [
          { cycle: 'mensal',    label: 'Mensal',    price:  109.99, stripe_price_id: 'price_1Tuz2tRNhmPZU5079NY2GmLc' },
          { cycle: 'semestral', label: 'Semestral', price: 593.99, stripe_price_id: 'price_1TuzAkRNhmPZU507q059dt8V' },
          { cycle: 'anual',     label: 'Anual',     price: 989.99, stripe_price_id: 'price_1TuzBCRNhmPZU507nN9G6gAP' },
        ],
      },
    ],
  },
    ...
    variants: [
      {
        ...
        prices: [
          ...
          { cycle: 'semestral', label: 'Semestral', price: 215.90, stripe_price_id: 'price_1U1XvRRNhmPZU507ZKGFYQJx' },
          { cycle: 'anual',     label: 'Anual',     price: 383.90, stripe_price_id: 'price_1U1XvRRNhmPZU5079ladqUWN' },
        ],
      },
    ],
  },
    ...
    variants: [
      {
        ...
        prices: [
          ...
          { cycle: 'semestral', label: 'Semestral', price: 161.99, stripe_price_id: 'price_1U55mzRNhmPZU507N8aN2qpz' },
          { cycle: 'anual',     label: 'Anual',     price: 287.99, stripe_price_id: 'price_1U55mzRNhmPZU507N3TFXMl1' },
        ],
      },
    ],
  },
